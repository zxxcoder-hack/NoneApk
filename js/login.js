    ...
    checkAuth() {
        ...
        if (token && user) {
            try {
                ...
                // Verify token is still valid (optional - could check expiration)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('keydown', function(e) {
        // Submit on Enter key (already handled by form submit)
        // Ctrl+Enter or Cmd+Enter as alternative
    ...
    // Add "Forgot password?" link (optional feature)
    ...
    // Handle OAuth/SSO buttons if they exist
    const ssoButtons = document.querySelectorAll('.sso-btn');
    ssoButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            e.preventDefault();
            alert('SSO login will be available in a future update.');
        });
    });
    ...
    // Add demo credentials (for testing only - remove in production)
